...
const Footer = () => (
  <footer className="translate-y-20 space-y-4 border-t-2 px-6 pt-6 lg:px-8">
    <div className="block justify-between max-sm:space-y-3 sm:flex">
      <div className="space-y-3 sm:w-1/2 lg:space-y-4">
        {/* Phone */}
        <div>
          <h6 className="font-bold lg:text-lg">Контактний телефон:</h6>
          <a href="tel:+380968381263">+380 (96) 838-12-63</a>
        </div>

        {/* Email */}
        <div>
          <h6 className="font-bold lg:text-lg">Електронна пошта:</h6>
          <a href="mailto:obladunokk@gmail.com">obladunokk@gmail.com</a>
        </div>

        {/* Socials */}
        <div>
          <h6 className="font-bold lg:text-lg">Соціальні мережі:</h6>
      ...
      <div className="space-y-3 sm:w-1/2 lg:space-y-4">
        {/* Address */}
        <div>
          <h6 className="font-bold lg:text-lg">Години роботи:</h6>
        ...
        {/* Address */}
        <div>
          <h6 className="font-bold lg:text-lg">Адреса:</h6>
    ...
    {/* Map */}
    <div className="mb-6 mt-4 lg:py-4">
      <iframe
    ...
    {/* Copyright */}
    <div className="-ml-6 flex w-screen flex-col gap-1 bg-[#E2E8F0] py-4 text-center text-xs lg:text-sm">
